...
import torch
from aug_oct import ImgTrainTransform, ImgEvalTransform
import datetime
...
def cnfg():
    ...
    # Dataset variables
    _folder = 1
    _base_path = "/home/patcha/Datasets/OCT2017"
    _csv_path_train = os.path.join(_base_path, "OCT_train.csv")
    _imgs_folder_train = os.path.join(_base_path, "train")
